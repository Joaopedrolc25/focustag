...
- [x] Publicado em HTTPS: **https://joaopedrolc25.github.io/focustag/** (GitHub Pages) e **https://focustag-app.vercel.app** (Vercel) — as duas no ar e testadas
- [x] Modo simulado testado a partir da URL ao vivo (sem erros, service worker registrado)
- [x] Publicado na Vercel (conta do João, projeto `focustag`): **https://focustag-app.vercel.app**
